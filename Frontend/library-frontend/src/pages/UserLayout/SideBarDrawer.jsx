        ...
        <Box
            sx={{
                ...
                '&::before': {
                    ...
                    right: 0,
                    height: '300px',
                    background: 'radical-gradient(circle at 50% 0%, rgba(99, 102, 241, 0.15) 0% , transparent 100%)',
                    pointerEvents: 'none',
                },
            }} >
                        ...
                        <Tooltip title={item.description} placement="right">
                            ...
                            <ListItemButton
                                ...
                                sx={{
                                    ...
                                    '&:hover': {
                                        bgcolor: active
                                            ? alpha('#6366f1', 0.3) : 'rgba(255,255,255,0.05)',
                                    ...
                                    '&::before': active ? {
                                        ...
                                        background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100% )',
                                        boxShadow: '0 0 12px rgpa(102, 126, 234, 0.6)',
                                    }
                                        : {},
                                }}
