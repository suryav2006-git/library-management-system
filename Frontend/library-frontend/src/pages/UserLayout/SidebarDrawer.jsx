...
import { Avatar, Box, Divider, List, ListItem, ListItemButton, ListItemIcon, Tooltip, Typography } from '@mui/material';
        ...
        <Box
            sx={{
                ...
                '&::before': {
                    ...
                    right: 0,
                    height: '300px',
                    background: 'radical-gradient(circle at 50% , rgba(99, 102, 241, 0.15) 0%, transparent 100%)',
                    pointerEvents: 'none',
                },
            }}
        >
            <Box sx={{
                ...
                <Box>
                    <Avatar sx={{
                        ...
                        fontWeigth: 'bold',
                        fontSize: '1.3rem',
                        boxShadow: '0 8px 24px rgpa(102, 126, 234, 0.4)',
                    }} >
                        <MenuBook />
                    </Avatar>
                </Box>
            ...
            <List>
                ...
                <Box sx={{ p: 2 }} >
                    ...
                    <p className='pt-2 text-xs text-grey-600' > © 2026 SURYA. ALL RIGHTS RESERVED </p>
